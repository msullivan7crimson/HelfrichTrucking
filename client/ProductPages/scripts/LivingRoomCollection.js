...
async function handleOnLoadLivingRoom(){
    await getFurniture()
...
//     const svg = document.getElementById("productspage");
//     let newContent = "";
//     myFurniture.forEach((furniture) => {
//         newContent += `<title>Placeholder</title>
//         <image href=${furniture.furnitureUrl} width="100%" height="100%"/>
...
//     const container = document.getElementById("livingroom");
//     container.innerHTML = "";  // Clear existing content if needed

//     myFurniture.forEach((furniture) => {
//         if(furniture.furnitureCollection === "Living Room"){
