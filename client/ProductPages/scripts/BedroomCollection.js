...
async function handleOnLoadBedroom(){
    await getFurniture()
...
//     const container = document.getElementById("bedroom");
//     container.innerHTML = "";  // Clear existing content if needed

//     myFurniture.forEach((furniture) => {
//         if(furniture.furnitureCollection === "Bedroom"){
...
//         // viewCartBtn.onclick = () => showCartModal();
