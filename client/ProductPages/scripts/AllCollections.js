...
async function handleOnLoadAllFurniture() {
    await getFurniture();
}
...
function renderSpecificCategory(){
    ...
    const categories = {
        ...
        "Chairs": document.getElementById('Chairs').checked,
        "Beds": document.getElementById('Beds').checked,
        "Storage": document.getElementById('Storage').checked,
        "Sofas": document.getElementById('Sofas').checked,
        "Outdoor & Garden": document.getElementById('Outdoor & Garden').checked
    }
    ...
    const anyCategoryActive = Object.values(categories).some(status => status);
    const anyConditionActive = Object.values(conditions).some(status => status);
 
    myFurniture.forEach((furniture) => {
        //if(furniture.furnitureCategory === currentCategory){
            if (!anyCategoryActive || Object.entries(categories).some(([category, isActiveCategory]) => {
                return isActiveCategory && furniture.furnitureCategory === category;
            })) {    
...
document.getElementById('Tables').addEventListener('change', renderSpecificCategory);
document.getElementById('Chairs').addEventListener('change', renderSpecificCategory);
document.getElementById('Beds').addEventListener('change', renderSpecificCategory);
document.getElementById('Storage').addEventListener('change', renderSpecificCategory);
document.getElementById('Sofas').addEventListener('change', renderSpecificCategory);
document.getElementById('Outdoor & Garden').addEventListener('change', renderSpecificCategory);
